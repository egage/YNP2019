...
## one of hundreds of differences between files: willid vs wilid. For constincy with latter files, I will go with wilid
w_ht <- w_ht %>% 
  rename(wilid = willid)
...
Source: _2017_Raw_Utilization.xlsx_
```{r}
# 2017 utilization
...
File provided by TH: _2001-2015time_series.csv_
...
_File: 2016_2017_Data_Entry_Format_WillowHt_2001_2015.csv_
...
File of missing records sent to me by TH on 20201118.
Not sure how complete it was produced. LM created the file I believe from raw field forms(?).

_File: MIssingWillowRecordsFromLewis_20201118.csv_ (Note: I added the date to the end of the file that was sent to me. Not sure the date of origin)
...
TH sent pdf of hist tallies on 20201118
